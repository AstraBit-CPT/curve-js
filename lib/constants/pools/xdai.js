...
const swap_json_1 = __importDefault(require("../abis/3pool/swap.json"));
const swap_json_2 = __importDefault(require("../abis/rai/swap.json"));
const deposit_json_1 = __importDefault(require("../abis/rai/deposit.json"));
const swap_json_3 = __importDefault(require("../abis/tricrypto-xdai/swap.json"));
const zap_json_1 = __importDefault(require("../abis/tricrypto-xdai/zap.json"));
const swap_json_4 = __importDefault(require("../abis/eureusd/swap.json"));
const zap_json_2 = __importDefault(require("../abis/eureusd/zap.json"));
const gauge_rewards_only_json_1 = __importDefault(require("../abis/gauge_rewards_only.json"));
const gauge_child_json_1 = __importDefault(require("../abis/gauge_child.json"));
const streamer_json_1 = __importDefault(require("../abis/streamer.json"));
exports.POOLS_DATA_XDAI = (0, utils_js_1.lowerCasePoolDataAddresses)({
    '3pool': {
        name: "3pool",
        full_name: "3pool",
        symbol: "3pool",
