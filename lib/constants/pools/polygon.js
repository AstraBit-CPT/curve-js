...
const swap_json_1 = __importDefault(require("../abis/aave/swap.json"));
const swap_json_2 = __importDefault(require("../abis/ren-polygon/swap.json"));
const swap_json_3 = __importDefault(require("../abis/atricrypto3/swap.json"));
const zap_json_1 = __importDefault(require("../abis/atricrypto3/zap.json"));
const swap_json_4 = __importDefault(require("../abis/eurtusd/swap.json"));
const deposit_json_1 = __importDefault(require("../abis/eurtusd/deposit.json"));
const gauge_child_json_1 = __importDefault(require("../abis/gauge_child.json"));
exports.POOLS_DATA_POLYGON = (0, utils_js_1.lowerCasePoolDataAddresses)({
    aave: {
        name: "aave",
        full_name: "aave",
        symbol: "aave",
