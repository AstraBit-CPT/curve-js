...
const swap_json_1 = __importDefault(require("../abis/2pool/swap.json"));
const swap_json_2 = __importDefault(require("../abis/fusdt/swap.json"));
const zap_json_1 = __importDefault(require("../abis/fusdt/zap.json"));
const swap_json_3 = __importDefault(require("../abis/ren-fantom/swap.json"));
const swapNoZap_json_1 = __importDefault(require("../abis/tricrypto/swapNoZap.json"));
const swap_json_4 = __importDefault(require("../abis/ib/swap.json"));
const swap_json_5 = __importDefault(require("../abis/aave/swap.json"));
...
exports.POOLS_DATA_FANTOM = (0, utils_js_1.lowerCasePoolDataAddresses)({
    '2pool': {
        name: "2pool",
        full_name: "2pool",
        symbol: "2pool",
