...
const gauge_synthetix_json_1 = __importDefault(require("../abis/gauge_synthetix.json"));
const gauge_v2_json_1 = __importDefault(require("../abis/gauge_v2.json"));
const gauge_v3_json_1 = __importDefault(require("../abis/gauge_v3.json"));
const gauge_v4_json_1 = __importDefault(require("../abis/gauge_v4.json"));
const gauge_v5_json_1 = __importDefault(require("../abis/gauge_v5.json"));
const gauge_factory_json_1 = __importDefault(require("../abis/gauge_factory.json"));
const deposit_json_1 = __importDefault(require("../abis/compound/deposit.json"));
const swap_json_1 = __importDefault(require("../abis/compound/swap.json"));
const deposit_json_2 = __importDefault(require("../abis/usdt/deposit.json"));
const swap_json_2 = __importDefault(require("../abis/usdt/swap.json"));
const deposit_json_3 = __importDefault(require("../abis/iearn/deposit.json"));
const swap_json_3 = __importDefault(require("../abis/iearn/swap.json"));
const deposit_json_4 = __importDefault(require("../abis/busd/deposit.json"));
const swap_json_4 = __importDefault(require("../abis/busd/swap.json"));
const deposit_json_5 = __importDefault(require("../abis/susdv2/deposit.json"));
const swap_json_5 = __importDefault(require("../abis/susdv2/swap.json"));
const sCurveRewards_json_1 = __importDefault(require("../abis/susdv2/sCurveRewards.json"));
const deposit_json_6 = __importDefault(require("../abis/pax/deposit.json"));
const swap_json_6 = __importDefault(require("../abis/pax/swap.json"));
const swap_json_7 = __importDefault(require("../abis/ren/swap.json"));
const swap_json_8 = __importDefault(require("../abis/sbtc/swap.json"));
const sCurveRewards_json_2 = __importDefault(require("../abis/sbtc/sCurveRewards.json"));
const swap_json_9 = __importDefault(require("../abis/hbtc/swap.json"));
const swap_json_10 = __importDefault(require("../abis/3pool/swap.json"));
const swap_json_11 = __importDefault(require("../abis/gusd/swap.json"));
const deposit_json_7 = __importDefault(require("../abis/gusd/deposit.json"));
const swap_json_12 = __importDefault(require("../abis/husd/swap.json"));
const deposit_json_8 = __importDefault(require("../abis/husd/deposit.json"));
const swap_json_13 = __importDefault(require("../abis/usdk/swap.json"));
const deposit_json_9 = __importDefault(require("../abis/usdk/deposit.json"));
const swap_json_14 = __importDefault(require("../abis/usdn/swap.json"));
const deposit_json_10 = __importDefault(require("../abis/usdn/deposit.json"));
const swap_json_15 = __importDefault(require("../abis/musd/swap.json"));
const deposit_json_11 = __importDefault(require("../abis/musd/deposit.json"));
const sCurveRewards_json_3 = __importDefault(require("../abis/musd/sCurveRewards.json"));
const swap_json_16 = __importDefault(require("../abis/rsv/swap.json"));
const deposit_json_12 = __importDefault(require("../abis/rsv/deposit.json"));
const sCurveRewards_json_4 = __importDefault(require("../abis/rsv/sCurveRewards.json"));
const swap_json_17 = __importDefault(require("../abis/tbtc/swap.json"));
const deposit_json_13 = __importDefault(require("../abis/tbtc/deposit.json"));
const sCurveRewards_json_5 = __importDefault(require("../abis/tbtc/sCurveRewards.json"));
const swap_json_18 = __importDefault(require("../abis/dusd/swap.json"));
const deposit_json_14 = __importDefault(require("../abis/dusd/deposit.json"));
const sCurveRewards_json_6 = __importDefault(require("../abis/dusd/sCurveRewards.json"));
const swap_json_19 = __importDefault(require("../abis/pbtc/swap.json"));
const deposit_json_15 = __importDefault(require("../abis/pbtc/deposit.json"));
const sCurveRewards_json_7 = __importDefault(require("../abis/pbtc/sCurveRewards.json"));
const swap_json_20 = __importDefault(require("../abis/bbtc/swap.json"));
const deposit_json_16 = __importDefault(require("../abis/bbtc/deposit.json"));
const swap_json_21 = __importDefault(require("../abis/obtc/swap.json"));
const deposit_json_17 = __importDefault(require("../abis/obtc/deposit.json"));
const sCurveRewards_json_8 = __importDefault(require("../abis/obtc/sCurveRewards.json"));
const swap_json_22 = __importDefault(require("../abis/seth/swap.json"));
const swap_json_23 = __importDefault(require("../abis/eurs/swap.json"));
const sCurveRewards_json_9 = __importDefault(require("../abis/eurs/sCurveRewards.json"));
const swap_json_24 = __importDefault(require("../abis/ust/swap.json"));
const deposit_json_18 = __importDefault(require("../abis/ust/deposit.json"));
const swap_json_25 = __importDefault(require("../abis/aave/swap.json"));
const rewards_json_1 = __importDefault(require("../abis/aave/rewards.json"));
const swap_json_26 = __importDefault(require("../abis/steth/swap.json"));
const sCurveRewards_json_10 = __importDefault(require("../abis/steth/sCurveRewards.json"));
const swap_json_27 = __importDefault(require("../abis/saave/swap.json"));
const swap_json_28 = __importDefault(require("../abis/ankreth/swap.json"));
const sCurveRewards_json_11 = __importDefault(require("../abis/ankreth/sCurveRewards.json"));
const swap_json_29 = __importDefault(require("../abis/usdp/swap.json"));
const deposit_json_19 = __importDefault(require("../abis/usdp/deposit.json"));
const swap_json_30 = __importDefault(require("../abis/ib/swap.json"));
const swap_json_31 = __importDefault(require("../abis/link/swap.json"));
const swap_json_32 = __importDefault(require("../abis/reth/swap.json"));
const swap_json_33 = __importDefault(require("../abis/factoryPools/swap.json"));
const deposit_json_20 = __importDefault(require("../abis/factoryPools/deposit.json"));
const rewards_json_2 = __importDefault(require("../abis/factoryPools/rewards.json"));
const swap_json_34 = __importDefault(require("../abis/tricrypto2/swap.json"));
const deposit_json_21 = __importDefault(require("../abis/tricrypto2/deposit.json"));
const swap_json_35 = __importDefault(require("../abis/eurt/swap.json"));
const swap_json_36 = __importDefault(require("../abis/eurtusd/swap.json"));
const deposit_json_22 = __importDefault(require("../abis/eurtusd/deposit.json"));
const swap_json_37 = __importDefault(require("../abis/eursusd/swap.json"));
const swap_json_38 = __importDefault(require("../abis/crveth/swap.json"));
const swap_json_39 = __importDefault(require("../abis/rai/swap.json"));
const deposit_json_23 = __importDefault(require("../abis/rai/deposit.json"));
const swap_json_40 = __importDefault(require("../abis/2pool/swap.json"));
const swap_json_41 = __importDefault(require("../abis/4pool/swap.json"));
const swap_json_42 = __importDefault(require("../abis/fraxusdc/swap.json"));
const swap_json_43 = __importDefault(require("../abis/frxeth/swap.json"));
const swap_json_44 = __importDefault(require("../abis/sbtc2/swap.json"));
const swap_json_45 = __importDefault(require("../abis/wbeth/swap.json"));
const llamma_json_1 = __importDefault(require("../abis/llamma.json"));
exports.POOLS_DATA_ETHEREUM = (0, utils_js_1.lowerCasePoolDataAddresses)({
    compound: {
        name: "compound",
        full_name: "compound",
        symbol: "compound",
    ...
    wbeth: {
        ...
        underlying_decimals: [18, 18],
        wrapped_decimals: [18, 18],
        swap_abi: swap_json_45.default,
        gauge_abi: gauge_v5_json_1.default,
    },
});
exports.LLAMMAS_DATA_ETHEREUM = (0, utils_js_1.lowerCasePoolDataAddresses)({
    'sfrxeth-llamma': {
        name: "sfrxeth",
        full_name: "sfrxeth",
        symbol: "sfrxeth",
        ...
        underlying_decimals: [18, 18],
        wrapped_decimals: [18, 18],
        swap_abi: llamma_json_1.default,
        gauge_abi: gauge_v5_json_1.default,
    },
});
