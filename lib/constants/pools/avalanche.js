...
const swap_json_4 = __importDefault(require("../abis/avaxcrypto/swap.json"));
const zap_json_2 = __importDefault(require("../abis/avaxcrypto/zap.json"));
const gauge_child_json_1 = __importDefault(require("../abis/gauge_child.json"));
exports.POOLS_DATA_AVALANCHE = (0, utils_js_1.lowerCasePoolDataAddresses)({
    aave: {
        name: "aave",
        full_name: "aave",
        symbol: "aave",
