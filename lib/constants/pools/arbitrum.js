...
const swap_json_2 = __importDefault(require("../abis/tricrypto2/swap.json"));
const deposit_json_1 = __importDefault(require("../abis/tricrypto2/deposit.json"));
const swap_json_3 = __importDefault(require("../abis/eursusd2/swap.json"));
const zap_json_1 = __importDefault(require("../abis/eursusd2/zap.json"));
const swap_json_4 = __importDefault(require("../abis/ren-arbitrum/swap.json"));
const gauge_child_json_1 = __importDefault(require("../abis/gauge_child.json"));
const swap_json_5 = __importDefault(require("../abis/wsteth/swap.json"));
exports.POOLS_DATA_ARBITRUM = (0, utils_js_1.lowerCasePoolDataAddresses)({
    '2pool': {
        name: "2pool",
        full_name: "2pool",
        symbol: "2pool",
