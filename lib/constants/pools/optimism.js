...
const swap_json_1 = __importDefault(require("../abis/3pool-optimism/swap.json"));
const swap_json_2 = __importDefault(require("../abis/wsteth/swap.json"));
const gauge_child_json_1 = __importDefault(require("../abis/gauge_child.json"));
exports.POOLS_DATA_OPTIMISM = (0, utils_js_1.lowerCasePoolDataAddresses)({
    '3pool': {
        name: "3pool",
        full_name: "3pool",
        symbol: "3pool",
