...
exports.FACTORY_CONSTANTS = exports.basePoolIdZapDictBsc = exports.basePoolIdZapDictBase = exports.basePoolIdZapDictZkSync = exports.basePoolIdZapDictCelo = exports.basePoolIdZapDictKava = exports.basePoolIdZapDictMoonbeam = exports.basePoolIdZapDictXDai = exports.basePoolIdZapDictOptimism = exports.basePoolIdZapDictArbitrum = exports.basePoolIdZapDictAvalanche = exports.basePoolIdZapDictFantom = exports.basePoolIdZapDictPolygon = exports.basePoolIdZapDictEthereum = exports.implementationABIDictBsc = exports.implementationABIDictBase = exports.implementationABIDictZkSync = exports.implementationABIDictCelo = exports.implementationABIDictKava = exports.implementationABIDictMoonbeam = exports.implementationABIDictXDai = exports.implementationABIDictOptimism = exports.implementationABIDictArbitrum = exports.implementationABIDictAvalanche = exports.implementationABIDictFantom = exports.implementationABIDictPolygon = exports.implementationABIDictEthereum = void 0;
const swap_json_1 = __importDefault(require("../constants/abis/factoryPools/swap.json"));
const MetaUSD_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaUSD.json"));
const MetaUSDBalances_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaUSDBalances.json"));
const MetaFraxUSD_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaFraxUSD.json"));
const MetaFraxUSDBalances_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaFraxUSDBalances.json"));
const MetaBTC_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaBTC.json"));
const MetaBTCBalances_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaBTCBalances.json"));
const MetaBTCRen_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaBTCRen.json"));
const MetaBTCBalancesRen_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaBTCBalancesRen.json"));
const MetaSbtc2_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaSbtc2.json"));
const MetaSbtc2Balance_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaSbtc2Balance.json"));
const MetaUSDGeist_json_1 = __importDefault(require("../constants/abis/factory-v2/MetaUSDGeist.json"));
const Plain2Basic_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain2Basic.json"));
const Plain2Balances_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain2Balances.json"));
const Plain2ETH_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain2ETH.json"));
const Plain2ETHOracle_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain2ETHOracle.json"));
const Plain2Optimized_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain2Optimized.json"));
const Plain3Basic_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain3Basic.json"));
const Plain3Balances_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain3Balances.json"));
const Plain3ETH_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain3ETH.json"));
const Plain3Optimized_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain3Optimized.json"));
const Plain4Basic_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain4Basic.json"));
const Plain4Balances_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain4Balances.json"));
const Plain4ETH_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain4ETH.json"));
const Plain4Optimized_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain4Optimized.json"));
const Plain6Basic_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain6Basic.json"));
const Plain6Balances_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain6Balances.json"));
const Plain6ETH_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain6ETH.json"));
const Plain6Optimized_json_1 = __importDefault(require("../constants/abis/factory-v2/Plain6Optimized.json"));
const plain_stableswap_ng_json_1 = __importDefault(require("../constants/abis/factory-stable-ng/plain-stableswap-ng.json"));
const meta_stableswap_ng_json_1 = __importDefault(require("../constants/abis/factory-stable-ng/meta-stableswap-ng.json"));
// --- ZAPS --
const deposit_json_1 = __importDefault(require("../constants/abis/factoryPools/deposit.json"));
const meta_zap_json_1 = __importDefault(require("../constants/abis/fraxusdc/meta_zap.json"));
const DepositZapMetaUsdPolygon_json_1 = __importDefault(require("../constants/abis/factory-v2/DepositZapMetaUsdPolygon.json"));
const DepositZapMetaBtcPolygon_json_1 = __importDefault(require("../constants/abis/factory-v2/DepositZapMetaBtcPolygon.json"));
const DepositZapFantom_json_1 = __importDefault(require("../constants/abis/factory-v2/DepositZapFantom.json"));
const DepositZapMetaUsd2Fantom_json_1 = __importDefault(require("../constants/abis/factory-v2/DepositZapMetaUsd2Fantom.json"));
const meta_zap_json_2 = __importDefault(require("../constants/abis/ren/meta_zap.json"));
const meta_zap_json_3 = __importDefault(require("../constants/abis/sbtc2/meta_zap.json"));
const utils_js_1 = require("../constants/utils.js");
exports.implementationABIDictEthereum = (0, utils_js_1.lowerCaseKeys)({
    ...
    "0x847ee1227A9900B73aEeb3a47fAc92c52FD54ed9": Plain2ETHOracle_json_1.default,
    "0x94b4DFd9Ba5865Cc931195c99A2db42F3fc5d45B": Plain2ETH_json_1.default,
    // !!! crvUSD Factory !!!
    "0x67fe41A94e779CcFa22cff02cc2957DC9C0e4286": Plain2Basic_json_1.default,
    "0x7Ca46A636b02D4aBC66883D7FF164bDE506DC66a": Plain2Balances_json_1.default,
    "0x36Dc03C0e12a1C241306a6A8F327Fe28bA2Be5b0": Plain2Basic_json_1.default,
    // !!! crvUSD Factory !!!
    ...
    "0x933f4769DCC27fC7345D9d5975AE48EC4D0F829C": plain_stableswap_ng_json_1.default,
    "0xDD7EBB1C49780519dD9755B8B1A23a6f42CE099E": meta_stableswap_ng_json_1.default,
});
exports.implementationABIDictPolygon = (0, utils_js_1.lowerCaseKeys)({
    ...
    "0xa7Ba18EeFcD9513230987eC2faB6711AF5AbD9c2": plain_stableswap_ng_json_1.default,
    "0x7C2085419BE6a04f4ad88ea91bC9F5C6E6C463D8": meta_stableswap_ng_json_1.default,
});
exports.implementationABIDictFantom = (0, utils_js_1.lowerCaseKeys)({
    ...
    // !!! EYWA Factory !!!
    "0x736FB582A39BC8f7685f87010c76C674F7fB583e": Plain6Basic_json_1.default,
    "0x2C996b11a73276787Eb637D4459d1A7fea16B310": Plain6Balances_json_1.default,
    "0xa4Fc50E45aF5bF22b519468c7c342C704e1F3d44": Plain6ETH_json_1.default,
    "0x65e38C41CcE6D9Bc202209Cc546B2f63985D4139": Plain6Optimized_json_1.default,
    ...
    "0xd7E72f3615aa65b92A4DBdC211E296a35512988B": plain_stableswap_ng_json_1.default,
    "0xbC0797015fcFc47d9C1856639CaE50D0e69FbEE8": meta_stableswap_ng_json_1.default,
});
exports.implementationABIDictAvalanche = (0, utils_js_1.lowerCaseKeys)({
...
exports.implementationABIDictArbitrum = (0, utils_js_1.lowerCaseKeys)({
    ...
    "0x73Ec37618683C274D0bBf5f5726aA856B2BDAB81": Plain2Basic_json_1.default,
    ...
    "0x6F9fb833501f46CBE6f6A4b6Cf32C834E5A5e8C5": Plain2ETHOracle_json_1.default,
    ...
    "0x0458ea5f4cd00e873264be2031ceb8f9d9b3116c": plain_stableswap_ng_json_1.default,
    "0xc6c09471ee39c7e30a067952fcc89c8922f9ab53": meta_stableswap_ng_json_1.default,
});
exports.implementationABIDictOptimism = (0, utils_js_1.lowerCaseKeys)({
    ...
    "0x06452f9c013fc37169B57Eab8F50A7A48c9198A3": plain_stableswap_ng_json_1.default,
    "0xd7E72f3615aa65b92A4DBdC211E296a35512988B": meta_stableswap_ng_json_1.default,
});
exports.implementationABIDictXDai = (0, utils_js_1.lowerCaseKeys)({
    ...
    "0xc9Fe0C63Af9A39402e8a5514f9c43Af0322b665F": plain_stableswap_ng_json_1.default,
    "0x166c4084Ad2434E8F2425C64dabFE6875A0D45c5": meta_stableswap_ng_json_1.default,
});
exports.implementationABIDictMoonbeam = (0, utils_js_1.lowerCaseKeys)({
...
exports.implementationABIDictKava = (0, utils_js_1.lowerCaseKeys)({
...
exports.implementationABIDictCelo = (0, utils_js_1.lowerCaseKeys)({
...
exports.implementationABIDictZkSync = (0, utils_js_1.lowerCaseKeys)({
    "0x7c2a205C52361410233540008f7095dEF5915843": Plain2Basic_json_1.default,
    "0xEF04fC6b95b1658AfdFd527aF9b947cd7BD46bde": Plain2Balances_json_1.default,
    "0x4887ef1a68f30364a25a8b0bAA13EeeA7eeBE574": Plain2ETH_json_1.default,
    "0x044f8F31078c0CB898f25fff3286cE905C18434e": Plain2Optimized_json_1.default,
    "0x2e6De7148Afc6e4B1ee766D070DDeff0C84831a5": Plain3Basic_json_1.default,
    "0x5D18b28C052Bb0C1573d90Ea055b13048026d83F": Plain3Balances_json_1.default,
    "0x9707Bbf96eBB136B67788aa7E46d771Ec18895f4": Plain3ETH_json_1.default,
    "0xb274f2cdCff70A0bac146e9Ca5a8a28f59a3f812": Plain3Optimized_json_1.default,
    "0x30eb3F0EF60993584e8dD231dF7539db31800555": Plain4Basic_json_1.default,
    "0x3D21E268d6A526948e978ad1595052c949927e54": Plain4Balances_json_1.default,
    "0xD46aed59fBd5eB6c134b1AFb364240bb62dA0451": Plain4ETH_json_1.default,
    "0xE80AeF1a4782eA7b7f9Ad9F0c2ed9343861934e3": Plain4Optimized_json_1.default,
});
exports.implementationABIDictBase = (0, utils_js_1.lowerCaseKeys)({
    "0xD166EEdf272B860E991d331B71041799379185D5": Plain2Basic_json_1.default,
    "0x5C627d6925e448Ae418BC8a45d56B31fe5009Bea": Plain2Balances_json_1.default,
    "0x22D710931F01c1681Ca1570Ff016eD42EB7b7c2a": Plain2ETH_json_1.default,
    "0xA50d9a424A14aF0b9e7e9243dc1597d977f6cB09": Plain2Optimized_json_1.default,
    "0xeD49979026DC44DC7E83b1471794ec9b2a365Ea2": Plain3Basic_json_1.default,
    "0x0Cc51c9786f3777a6d50961CEBb2BB6E69ec5e07": Plain3Balances_json_1.default,
    "0x0a31527a8dE2Ee97BBD8cCE14Db8E8826a0b6C4f": Plain3ETH_json_1.default,
    "0x1086F023146f9026A9Bb22983CE866813C59518A": Plain3Optimized_json_1.default,
    "0x1621E58d36EB5Ef26F9768Ebe9DB77181b1f5a02": Plain4Basic_json_1.default,
    "0x2FdDeDF2D842f23da2B81b9144e75cEcb691Bf19": Plain4Balances_json_1.default,
    "0x50E09Ee7080b32aef3e92346891dD2DD389B5fAf": Plain4ETH_json_1.default,
    "0x44d9B3f4EE15AC81FEb918501fca0ddc9d83C976": Plain4Optimized_json_1.default,
    //"0x1764ee18e8B3ccA4787249Ceb249356192594585": PlainStableSwapNGABI,
    //"0x5eee3091f747e60a045a2e715a4c71e600e31f6e": MetaStableSwapNGABI,
    "0x604388Bb1159AFd21eB5191cE22b4DeCdEE2Ae22": plain_stableswap_ng_json_1.default,
    "0x06452f9c013fc37169B57Eab8F50A7A48c9198A3": meta_stableswap_ng_json_1.default,
});
exports.implementationABIDictBsc = (0, utils_js_1.lowerCaseKeys)({
    "0xB90B9B1F91a01Ea22A182CD84C1E22222e39B415": Plain2Basic_json_1.default,
    "0x7CDE88e96E9445D986537074B1bFD32c5623c71f": Plain2Balances_json_1.default,
    "0x5BD917879e04Cf18EC79285a1C960C5fbA7f5EA3": Plain2ETH_json_1.default,
    "0x630C7Ad3998f397df0c0A8FfDB7a65B61ec5539E": Plain2Optimized_json_1.default,
    "0xD166EEdf272B860E991d331B71041799379185D5": Plain3Basic_json_1.default,
    "0x5C627d6925e448Ae418BC8a45d56B31fe5009Bea": Plain3Balances_json_1.default,
    "0x22D710931F01c1681Ca1570Ff016eD42EB7b7c2a": Plain3ETH_json_1.default,
    "0xA50d9a424A14aF0b9e7e9243dc1597d977f6cB09": Plain3Optimized_json_1.default,
    "0xeD49979026DC44DC7E83b1471794ec9b2a365Ea2": Plain4Basic_json_1.default,
    "0x0Cc51c9786f3777a6d50961CEBb2BB6E69ec5e07": Plain4Balances_json_1.default,
    "0x0a31527a8dE2Ee97BBD8cCE14Db8E8826a0b6C4f": Plain4ETH_json_1.default,
    "0x1086F023146f9026A9Bb22983CE866813C59518A": Plain4Optimized_json_1.default,
    ...
    "0x64379C265Fc6595065D7d835AAaa731c0584dB80": plain_stableswap_ng_json_1.default,
    "0xd3B17f862956464ae4403cCF829CE69199856e1e": meta_stableswap_ng_json_1.default,
});
...
exports.basePoolIdZapDictZkSync = {};
exports.basePoolIdZapDictBase = {};
exports.basePoolIdZapDictBsc = {};
exports.FACTORY_CONSTANTS = {
    ...
    56: {
        implementationABIDict: exports.implementationABIDictBsc,
        basePoolIdZapDict: exports.basePoolIdZapDictBsc,
    },
    100: {
    ...
    324: {
        implementationABIDict: exports.implementationABIDictZkSync,
        basePoolIdZapDict: exports.basePoolIdZapDictZkSync,
    },
    1284: {
    ...
    8453: {
        implementationABIDict: exports.implementationABIDictBase,
        basePoolIdZapDict: exports.basePoolIdZapDictBase,
    },
    42220: {
