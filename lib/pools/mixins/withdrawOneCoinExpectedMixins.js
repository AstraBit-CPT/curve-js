...
exports.withdrawOneCoinExpectedMetaFactoryMixin = {
    async _withdrawOneCoinExpected(_lpTokenAmount, i) {
        ...
        return await contract.calc_withdraw_one_coin(this.address, _lpTokenAmount, i, curve_js_1.curve.constantOptions);
    },
};
// @ts-ignore
...
exports.withdrawOneCoinExpected3argsMixin = {
    async _withdrawOneCoinExpected(_lpTokenAmount, i) {
        ...
        return await contract.calc_withdraw_one_coin(_lpTokenAmount, i, true, curve_js_1.curve.constantOptions);
    },
};
// @ts-ignore
